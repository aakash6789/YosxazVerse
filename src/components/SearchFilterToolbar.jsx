...
const SearchFilterToolbar = () => {
  return (
    ...
    <div className='relative w-[40%] pl-[2%]'>
      <h2 className='text-bold absolute font-playfair text-[3xl] font-bold'>What are you looking for?</h2>
      <SearchIcon color="disabled" className='absolute left-5 top-[3.5dvh] z-10  h-[3%]' />
      <input type='search' className='w-[80%] mt-[25px] mb-[px] h-[3dvh] pl-[4dvh] absolute left-5 ' placeholder='Search for name, category, company etc'></input>
      {/* <div className='w-[50%] mt-[25px] mb-[10px] h-[5%]'>
      <TextField
    ...
    <div className='relative w-[20%] flex-shrink-2'>
      <h2 className='text-bold absolute font-playfair text-[3xl] font-bold '>Category</h2>
    ...
    <div className='relative w-[20%] flex-shrink-2 h-[6.5dvh]'>
      <h2 className='text-bold absolute font-playfair text-[3xl] font-bold '>Status</h2>
