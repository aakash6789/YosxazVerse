...
const ProductSummary = () => {
  ...
  return (
    <div className="absolute w-4/5 mt-[18dvh] text-[0.7em] xs:text-[0.001em]">
      <div className="flex">
        <h1 className="ml-[2%] font-playfair text-[2xl] font-bold">
          Product Summary
        </h1>
        ...
        <select
          id="coloumn"
          name="coloumn"
          className="w-[15%] ml-[35px] pl-[5px] font-playfair text-[3xl] font-bold "
        >
          <option value="coloumn1">All Coloumn</option>
          <option value="coloumn1">coloumn1</option>
          <option value="coloumn2">coloumn2</option>                                                 {/*Data component ie containing values of all the fields */}
          <option value="coloumn3">coloumn3</option>
          <option value="coloumn4">coloumn4</option>
        </select>
        <button className="w-[15%]  ml-[3dvw] bg-[#4942E4] text-white rounded ">
          DISPATCH SELECTED
        </button>
        <div className="flex w-[20%] justify-between ml-[3dvw] ">
          ...
          <button className="focus:bg-[#4942E4] focus:text-white focus:rounded p-2">
            1
          </button>
          <button className="focus:bg-[#4942E4] focus:text-white focus:rounded p-2">                          {/*To display page buttons */}
            2
          </button>{" "}
          {/* */}
          <button className="focus:bg-[#4942E4] focus:text-white focus:rounded p-2">
      ...
      <div className="flex justify-between mt-[15px] text-[0.5em] md:text-[1em] w-full ">
        ...
        <div className="w-[7%] text-left">CUSTOMER</div>                                                           {/*To display column names */}
